import unittest
from ipycc.turtle import Turtle, Vec2D, TurtleGraphicsError, tracer
...
class TestNavigation(VectorComparisonMixin, unittest.TestCase):
...
class TestTurtle(unittest.TestCase):
    def setUp(self):
        ...
        self.addCleanup(setattr, Turtle, '_Screen', None)
    ...
    def test_dot_signature(self):
        ...
        self.assertRaises(TurtleGraphicsError, self.turtle.dot, "_not_a_color_")
        self.assertRaises(TurtleGraphicsError, self.turtle.dot, 0, (0, 0, 0, 0))
        self.assertRaises(TurtleGraphicsError, self.turtle.dot, 0, 0, 0, 0, 0)
        self.assertRaises(TurtleGraphicsError, self.turtle.dot, 0, (-1, 0, 0))
        self.assertRaises(TurtleGraphicsError, self.turtle.dot, 0, -1, 0, 0)
        self.assertRaises(TurtleGraphicsError, self.turtle.dot, 0, (0, 257, 0))
        self.assertRaises(TurtleGraphicsError, self.turtle.dot, 0, 0, 257, 0)
